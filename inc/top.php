    ...
    <div class="w3-bar w3-card">
        <div class="w3-dropdown-hover">
            ...
            <div class="w3-dropdown-content w3-bar-block w3-card-4">
                ...
                <a href="#"
                   class="w3-bar-item w3-button"><i><?= $_SESSION['user']['firstname'] . ' ' . $_SESSION['user']['lastname']; ?></i></a>
                <a href="delog.php" class="w3-bar-item w3-button"><i class="fa-solid fa-person-walking-arrow-right"></i>
                    Se deconnecter</a>
            </div>
        </div>
