...
<div class="w3-row-padding">
    <div class="w3-half">
        <a href="index.php?element=modules&action=update&nummod=<?= $moduleCarte->nummod; ?>"
...
<div id="modal_delete" class="modal" style="display:none;">
    ...
    <form class="modal-content"
          action="index.php?element=modules&action=delete&nummod=<?= $moduleCarte->nummod; ?>"
          method="POST">
        <div class="container">
            <h1>Supprimer le module</h1>
            <p>Les matières associés seront également supprimées.<br/>
                Êtes-vous sûr de vouloir supprimer ce module ?</p>
            <div class="clearfix">
...
<div class="dtitle w3-container w3-teal">
    Classement des étudiants pour ce module
</div>
